...
test_name = "Playback_on_Mobile_Device"
...
def main():
    ...
    try:
        ...
        # Start audio playbook on Mobile Device 1
        ...
        save_to_notepad(f"Checking if Bluetooth audio source is active on HU\n")
        time.sleep(2)
        ...
        # Check test result
        if found == True:
            success_message = f"Audio playback is initiated on HU and Bluetooth audio source is active - test Passed."
