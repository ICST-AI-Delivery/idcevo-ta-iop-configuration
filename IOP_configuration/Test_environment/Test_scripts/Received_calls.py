...
def main():
    ...
    try:
        ...
        result = phone.get_received_calls()
        if result is None:
            raise AssertionError("get_received_calls() returned None - unable to retrieve call data")
        ...
        if found == True:
            success_message = f"{mobile_name} received calls were found successfully on HU display"
            ...
            assert False, f"{mobile_name} received calls were not found on HU display.\n"
