...
def main():
    ...
    try:
        ...
        # Click Not now on HU (may not appear)
        ...
        # Click Cancel on HU
        found = click_on_device_with_verification(HU, "Cancel")
        time.sleep(2)
        ...
        if found==False:
            success_message = f"Pairing was denied successfully by HU and {mobile_name}."
            ...
            assert found == False, f"Pairing denied by HU doesn't work properly.\n"
