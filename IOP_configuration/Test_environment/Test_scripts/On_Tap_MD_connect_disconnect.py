...
test_name = "On_Tap_MD_connect_disconnect"
...
def main():
    ...
    try:
        ...
        for cmd in commands:
            ...
            if cmd == commands[1]:
                if found == False:
                    ...
                    success_message = f"HU has been disconnected successfully from {mobile_name}."
        ...
        if found == False:
            ...
            success_message = f"HU has been disconnected and reconnected successfully with {mobile_name}."
            save_to_notepad(f"{success_message}\n")
