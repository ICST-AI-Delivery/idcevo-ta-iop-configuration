...
def main():
    ...
    try:
        ...
        result = phone.get_dialed_calls()
        if result is None:
            raise AssertionError("get_dialed_calls() returned None - unable to retrieve call data")
        ...
        if found == True:
            success_message = f"{mobile_name} dialed calls were found successfully on HU display"
            ...
            assert False, f"{mobile_name} dialed calls were not found on HU display.\n"
