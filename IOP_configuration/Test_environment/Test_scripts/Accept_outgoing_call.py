"""
AI-Generated Test Script for: Accept_outgoing_call
Generated on: 2026-03-04 10:42:56
...
- Expected Result: 2 Call is active on Mobile Device and HU. Audio is transmitted in both directions.
"""
...
test_name = "Accept_outgoing_call"
...
def main():
    ...
    try:
        ...
        time.sleep(5)  # Wait for call to be initiated
        ...
        time.sleep(3)  # Wait for call to be established
        ...
        # Check if call is active on HU display by looking for last 3 digits of mobile called
        found = find_word_on_device_via_regex(HU, last_3_digits)
        if found:
            success_message = f"Call is active on {mobile_name} and HU. Audio is transmitted in both directions."
            ...
            assert False, f"Call is not active properly on HU display.\n"
